  ...
  <div class="pri">
    <aside>
      <nav>
        ...
        <ul>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php" id="categoria-todos">Todo</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=1" id="categoria-aseo">Aseo</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=2" id="categoria-alimento">Alimento</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=3" id="categoria-juguetes">Juguetes</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=4" id="categoria-medicamentos">Medicamentos</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=5" id="categoria-accesorios">Accesoriso</a></li>
          <li><a href="<?php echo URL ?>/catalogo/catalogo.php?categoria=6" id="categoria-higiene">Higiene y cuidado</a></li>
        </ul>
      </nav>
    </aside>
    <div class="main" style="width: 85%;">
      ...
      <div class="contenedor" name="contenedor" id="contenedor">
        <?php
        $url = URL.'/controller/producto.php';
