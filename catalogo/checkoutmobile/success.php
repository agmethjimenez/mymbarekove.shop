...
if (isset($_GET['payment_id'], $_GET['status'], $_GET['payment_type'], $_GET['merchant_order_id'], $_SESSION['id_usuario'], $_SESSION['carrito'], $_SESSION['direccion'], $_SESSION['ciudad'])) {
    ...
    $url_pedido = 'http://' . URL2 . '/controller/pedido.php';
    ...
    if ($httpcode == 200) {
        ...
        if ($response_data['exito']) {
            ...
            echo '<script>window.location.href = "http://' . URL2 . '/catalogo/pedido/verpedidos.php";</script>';
        } else {
            // Error en el pedido
    ...
    echo '<script>alert("ERROR: Faltan parámetros en la URL.");</script>';
}
?>